...
export default function HomeScreen() {
          ...
          return (
               <View style={[styles.book, { backgroundColor: '#40ccf775' }]}>
                    ...
                    <View style={{ flexDirection: 'row', gap: ms(10), paddingVertical: ms(10) }}>
                         <View style={{ backgroundColor: Colors.background, borderRadius: 5, width: '49%', paddingVertical: ms(5), paddingHorizontal: 10, position: 'relative', flexDirection: 'row', gap: 5 }}>
                    ...
                    <View style={{ backgroundColor: Colors.background, borderRadius: 5, width: 'auto', paddingVertical: ms(5), paddingHorizontal: 10, position: 'relative', flexDirection: 'row', gap: 5, marginBottom: ms(20) }}>
     ...
     return (
          <SafeAreaView style={[styles.container, { paddingHorizontal: ms(isTablet ? 40 : 15) }]}>
               {/* <ScrollView showsHorizontalScrollIndicator={false} style={{ flex: 1 }} contentContainerStyle={{ gap: ms(30) }}>          */}
                    <UpcomingRide />
